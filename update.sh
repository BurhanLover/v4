...
wget -q -O /usr/bin/auto-reboot "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/auto-reboot.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/Andyyuda/v4/main/ssh/tendang.sh"
wget -q -O /usr/bin/clearcache "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/clearcache.sh"
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/running.sh"
wget -q -O /usr/bin/speedtest "https://raw.githubusercontent.com/Andyyuda/v4/main/ssh/speedtest_cli.py"
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/menu-vmess.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/menu-trojan.sh"
wget -q -O /usr/bin/menu-ssh "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/menu-ssh.sh"
wget -q -O /usr/bin/menu-backup "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/menu-backup.sh"
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/menu.sh"
wget -q -O /usr/bin/menu-webmin "https://raw.githubusercontent.com/Andyyuda/v4/main/menu/menu-webmin.sh"
wget -q -O /usr/bin/xp "https://raw.githubusercontent.com/Andyyuda/v4/main/ssh/xp.sh"
wget -q -O /usr/bin/update "https://raw.githubusercontent.com/Andyyuda/v4/main/update.sh"
wget -q -O /usr/bin/add-host "https://raw.githubusercontent.com/Andyyuda/v4/main/ssh/add-host.sh"
wget -q -O /usr/bin/certv2ray "https://raw.githubusercontent.com/Andyyuda/v4/main/xray/certv2ray.sh"
