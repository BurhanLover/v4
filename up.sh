...
cd /usr/bin
# menu
wget -O menu "https://raw.githubusercontent.com/Andyyuda/ver4/main/menu/menu.sh"
...
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/Andyyuda/ver4/main/menu/menu.sh" && chmod +x /usr/bin/menu
